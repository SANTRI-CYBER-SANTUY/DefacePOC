...
echo $purple" (+) WHATSAPP     : +6282134566596        (+)"
echo $green"×××××××××××××××××××××××××××××××××××××××××××××××××××××××××"
echo $white
echo "BERIKUT ADALAH WEBSITE YG BISA KAMU DEFACE DGN MUDAH CUK"
echo $green"======================================================="
sleep 1
echo
...
echo $white"5.) " $red"DEFACE GWE"
echo $white"6.) " $red"KELUAR"
echo $green
sleep 1
...
clear
sleep 1
xdg-open https://santri-cyber-santuy.github.io/
fi
if [ $ger = 6 ]
then
   exit -y
